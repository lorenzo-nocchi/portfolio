...
import "./App.css";
import DoomWindow from "./Doom.jsx";
...
// Vérifier que window.Dos est défini globalement
if (!window.Dos) {
      ...
      {selected && (
          <div className="proj-modal-overlay" onClick={() => setSelected(null)}>
            <div className="proj-modal-wrapper">
              <div className="proj-modal-close-bar">
...
function AlternanceWindow() {
  const [activeTab, setActiveTab] = useState("presentation");

  return (
    <div className="alternance-wrap">
      <div className="alternance-tabs">
        <button 
          className={`alternance-tab ${activeTab === "presentation" ? "active" : ""}`}
          onClick={() => setActiveTab("presentation")}
        >
          Présentation
        </button>
        <button 
          className={`alternance-tab ${activeTab === "missions" ? "active" : ""}`}
          onClick={() => setActiveTab("missions")}
        >
          Missions
        </button>
        <button 
          className={`alternance-tab ${activeTab === "retrospective" ? "active" : ""}`}
      ...
      <div className="alternance-content">
        {activeTab === "presentation" && (
          <div className="alternance-section">
            <h2 className="alternance-title">Présentation de l'entreprise</h2>
            <div className="alternance-card">
              <div className="alternance-card-header">
                <div className="alternance-company-badge">🏢</div>
                <div>
                  <h3>AutoPartsPro</h3>
                  <p className="alternance-meta">After Market Automobile · Gimont (32)</p>
                </div>
              </div>
              <div className="alternance-card-body">
                <p>
                  <b>AutoPartsPro</b> est une entreprise spécialisée dans les solutions digitales pour <b>l'après-vente automobile</b>, fondée par Franck Dartus et issue de Graphibox, une <b>agence digitale</b> avec plus de 15 ans d'expérience dans le secteur <b>automobile</b>. Basée à Gimont, dans le Gers, elle s'est imposée comme un <b>acteur de référence</b> dans la transformation numérique des professionnels de la <b>distribution</b> et de la <b>réparation</b> automobile.
                </p>
                <p style={{ marginTop: "12px" }}>
                  Elle conçoit et commercialise des outils à destination des <b>distributeurs de pièces détachées</b> (BtoB) et des <b>garagistes</b> (BtoC), en s'appuyant sur des <b>données techniques</b> de premier plan comme <b>TecDoc, TecRMI et Haynes</b>. Ses solutions sont aujourd'hui utilisées par environ <b>12 000 professionnels</b> au quotidien, témoignant d'une présence solide dans un secteur en pleine mutation digitale.
                </p>
              </div>
            </div>

            <h3 className="alternance-subtitle" style={{ marginTop: "20px" }}>Valeurs & Culture</h3>
            <div className="alternance-values">
              <div className="alternance-value-item">
                <span className="alternance-value-icon">🚀</span>
                <div>
                  <strong>Innovation</strong>
                  <p>Approche moderne et agile</p>
                </div>
              </div>
              <div className="alternance-value-item">
                <span className="alternance-value-icon">👥</span>
                <div>
                  ...
                  <p>Travail en équipe dynamique</p>
                </div>
              </div>
              <div className="alternance-value-item">
                <span className="alternance-value-icon">📈</span>
        ...
        {activeTab === "missions" && (
            <div className="alternance-section">
              <h2 className="alternance-title">Missions & Responsabilités</h2>
              ...
              <div className="alternance-card">
                ...
                <div className="alternance-card-body">
                  <p className="alternance-role">Chargé de Projet Digital</p>
                  <p className="alternance-duration">12 mois — AutoPartsPro, Gimont (32)</p>
                </div>
              </div>

              <h3 className="alternance-subtitle" style={{ marginTop: "20px" }}>Mes Missions Principales</h3>
              <div className="alternance-missions">
                <div className="alternance-mission-item">
                  <div className="alternance-mission-icon">1️⃣</div>
                  <div className="alternance-mission-content">
                    <h4>Gestion de Projet & Relation Client</h4>
                    <p>Pilotage de projets digitaux en lien direct avec les clients : organisation de visios Teams, rendez-vous en présentiel et coordination d'équipe pour assurer le bon déroulement des livrables.</p>
                    <div className="alternance-mission-tags">
                      <span className="alternance-tag">Microsoft Teams</span>
                      <span className="alternance-tag">Management</span>
                      <span className="alternance-tag">Relation client</span>
                    </div>
                  </div>
                </div>

                <div className="alternance-mission-item">
                  <div className="alternance-mission-icon">2️⃣</div>
                  <div className="alternance-mission-content">
                    <h4>Automatisation & Développement</h4>
                    <p>Conception et développement de workflows d'automatisation sur n8n, avec manipulation de données via JavaScript et SQL. Création de pipelines pour optimiser les processus internes et réduire les tâches manuelles.</p>
                    <div className="alternance-mission-tags">
                      <span className="alternance-tag">n8n</span>
                      <span className="alternance-tag">JavaScript</span>
                      <span className="alternance-tag">SQL</span>
                    </div>
                  </div>
                </div>

                <div className="alternance-mission-item">
                  <div className="alternance-mission-icon">3️⃣</div>
                  <div className="alternance-mission-content">
                    <h4>Design & Intégration Web</h4>
                    <p>Conception et design d'un site web à destination des garagistes, en veillant à l'expérience utilisateur et à la cohérence visuelle pour un public professionnel de l'automobile.</p>
                    <div className="alternance-mission-tags">
                      <span className="alternance-tag">UI/UX</span>
                      <span className="alternance-tag">Design web</span>
                      <span className="alternance-tag">Intégration</span>
                    </div>
                  </div>
                </div>

                <div className="alternance-mission-item">
                  <div className="alternance-mission-icon">4️⃣</div>
                  <div className="alternance-mission-content">
                    <h4>Marketing Digital & Contenu</h4>
                    <p>Actions SEO/SEA, rédaction d'articles et mise en place d'une automatisation de production de contenu via IA. Rédaction de documentations techniques à destination des équipes et des clients.</p>
                    <div className="alternance-mission-tags">
                      <span className="alternance-tag">SEO / SEA</span>
                      <span className="alternance-tag">IA générative</span>
                      <span className="alternance-tag">Documentation</span>
                    </div>
                  </div>
                </div>
              </div>

              <h3 className="alternance-subtitle" style={{ marginTop: "20px" }}>Répartition des Tâches</h3>
              <div className="alternance-chart">
                <div className="alternance-chart-bar">
                  <div className="alternance-chart-fill" style={{ width: "75%", background: "linear-gradient(90deg, #e05c5c, #f0a04a)" }}></div>
                  <span className="alternance-chart-label">Gestion de projet</span>
                </div>
                <div className="alternance-chart-bar">
                  <div className="alternance-chart-fill" style={{ width: "50%", background: "linear-gradient(90deg, #c45fa0, #e05c5c)" }}></div>
                  <span className="alternance-chart-label">Automatisation & Dev</span>
                </div>
                <div className="alternance-chart-bar">
                  <div className="alternance-chart-fill" style={{ width: "30%", background: "linear-gradient(90deg, #7a5555, #c45fa0)" }}></div>
                  <span className="alternance-chart-label">Design web</span>
                </div>
                <div className="alternance-chart-bar">
                  <div className="alternance-chart-fill" style={{ width: "15%", background: "linear-gradient(90deg, #4a7aa0, #7a5555)" }}></div>
                  <span className="alternance-chart-label">Marketing & Contenu</span>
                </div>
              </div>
            </div>
        )}
        ...
        {activeTab === "retrospective" && (
            <div className="alternance-section">
              <h2 className="alternance-title">Rétrospective & Apprentissages</h2>

              <div className="alternance-retrospective">
                <div className="alternance-retro-item">
                  <div className="alternance-retro-icon">💡</div>
                  <div className="alternance-retro-content">
                    <h3>Ce que j'ai Appris</h3>
                    <ul className="alternance-list">
                      <li>Maîtriser n8n pour concevoir des automatisations robustes et scalables</li>
                      <li>Appréhender les enjeux métier du secteur de l'après-vente automobile</li>
                      <li>Piloter un projet de A à Z, de la phase de cadrage à la livraison client</li>
                      <li>Utiliser l'IA comme levier de productivité pour la création de contenu</li>
                    </ul>
                  </div>
                </div>
                ...
                <div className="alternance-retro-item">
                  ...
                  <div className="alternance-retro-content">
                    ...
                    <ul className="alternance-list">
                      <li>Une posture de chef de projet : écoute client, priorisation et communication</li>
                      <li>Une vraie polyvalence technique entre développement, design et marketing</li>
                      <li>La capacité à vulgariser des sujets techniques pour des interlocuteurs non-dev</li>
                      <li>Une expérience concrète dans une PME en croissance du digital automobile</li>
                    </ul>
                  </div>
                </div>
                ...
                <div className="alternance-retro-item">
                  ...
                  <div className="alternance-retro-content">
                    <h3>Défis Relevés</h3>
                    <ul className="alternance-list">
                      <li>Automatiser des processus complexes avec des données hétérogènes et volumineuses</li>
                      <li>Adapter le design d'un site web aux attentes d'un public professionnel très spécifique</li>
                      <li>Gérer la relation client en autonomie : recueil du besoin, arbitrage et restitution</li>
                      <li>Structurer une documentation technique claire, maintenable et accessible</li>
                    </ul>
                  </div>
                </div>
              </div>

              <div className="alternance-card" style={{ marginTop: "20px" }}>
                <div className="alternance-card-header">
                  <h3>Conclusion</h3>
                </div>
                <div className="alternance-card-body">
                  <p>
                    Cette alternance chez AutoPartsPro m'a confronté à une réalité rarement enseignée : la polyvalence. Entre la gestion de projet, le développement d'automatisations, le design et le marketing, j'ai appris à jongler entre des contextes très différents tout en maintenant une vision globale des objectifs.
                  </p>
                  <p style={{ marginTop: "12px" }}>
                    Travailler dans une PME à taille humaine m'a donné une vraie responsabilité dès le départ, avec des projets concrets et des clients réels. C'est cette exposition directe au terrain qui a le plus accéléré ma progression, bien au-delà de ce qu'un cadre purement académique aurait pu m'apporter.
                  </p>
                </div>
              </div>
              ...
              <div className="alternance-card" style={{ marginTop: "20px" }}>
                ...
                <div className="alternance-card-body">
                  <p>
                    Après mon Bachelor, j'aimerais aller en Master Digital Design & Creative Technologies à l'ESD pour continuer à développer mes compétences de design tout en gardant une alternance dans la gestion de projet pour développer mes compétences de chef de projet digital.
                  </p>
                  <p style={{ marginTop: "12px" }}>
                    J'aimerai être capable de gérer un projet de A à Z : ce que je suis en train de développer dans mon alternance actuelle. De l'idée du client, aux discussions avec les développeurs et jusqu'au rendu final, piloter un projet du début à la fin me donne l'impression que ce que je fais a un sens.
                  </p>
                </div>
              </div>
            </div>
...
const WINDOWS_DEF = [
  ...
  { id: "alternance", title: "Alternance 2026", icon: "💼",
    initialPosFn: (vw, vh, w, h) => ({
      x: clamp(Math.round(vw * 0.15), 10, Math.max(0, vw - w - 10)),
      y: clamp(Math.round(vh * 0.2), 10, Math.max(0, vh - h - 68)),
    }),
    initialSizeFn: (vw, vh) => ({
      w: clamp(Math.round(vw * 0.6), 420, 900),
      h: clamp(Math.round((vh - 58) * 0.75), 400, 700),
    }),
    content: <AlternanceWindow /> },
  ...
  { id: "doom", title: "DOOM", icon: "👾", desktopOnly: true,
    initialPosFn: (vw, vh, w, h) => ({
      x: clamp(Math.round(vw * 0.25), 10, Math.max(0, vw - w - 10)),
      y: clamp(Math.round(vh * 0.1), 10, Math.max(0, vh - h - 68)),
    }),
    initialSizeFn: () => ({ w: 640, h: 480 }),
    content: <DoomWindow /> },
];
...
const TASKBAR_ICONS = [
  ...
  { id: "alternance", icon: "💼", label: "Alternance 2026" },
];
    ...
    <div className="desktop">
      ...
      <div className="desktop-icons">
        {TASKBAR_ICONS.map((ic) => (
          <div key={ic.id} className="desktop-icon" onClick={() => toggleWindow(ic.id)}>
            <div className="desktop-icon-img">{ic.icon}</div>
            <div className="desktop-icon-label">{ic.label}</div>
          </div>
        ))}
        <div className="desktop-icon" onClick={() => openGame("snake")}>
          <div className="desktop-icon-img">🐍</div>
          <div className="desktop-icon-label">Snake</div>
        </div>
        <div className="desktop-icon" onClick={() => openGame("minesweeper")}>
          <div className="desktop-icon-img">💣</div>
          <div className="desktop-icon-label">Démineur</div>
        </div>
        <div className="desktop-icon" onClick={() => openGame("doom")}>
          <div className="desktop-icon-img">👾</div>
          <div className="desktop-icon-label">DOOM (1993)</div>
        </div>
      </div>
      ...
      {WINDOWS_DEF.filter(w => openWindows.includes(w.id)).map(w => (
        ...
        >
          {/* Contenu spécial pour DOOM : reçoit onClose */}
          {w.id === "doom"
